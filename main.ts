            ...
            if (cmd == 'new') {
                ...
                switch(await canInitiateNewGame(interaction)) {
                    case 0: 
                        ...
                        break;
                    case NewGameErr.NotEnoughPlayers: 
                        interaction.editReply({content: `You must have at least ${TRAINC.MIN_PLAYERS} to start a new game.`});
                        break;
                    case NewGameErr.KeyAlreadyExists:
                        interaction.editReply({content: `A game already exists in this server. TODO write instructions on how to cancel it and make a new game.`});
                        break;
                    default:
